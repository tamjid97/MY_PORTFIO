      ...
      <div className="relative max-w-6xl w-full flex flex-col-reverse md:flex-row items-center justify-between gap-10 md:gap-6 z-10">
        ...
        >
          <div className="space-y-2 md:space-y-3">
            ...
            >
              <Typewriter
                words={["Full Stack Developer_", "Frontend Enthusiast_", "Problem Solver_"]}
                loop={0}
                cursor
                cursorStyle="|"
                typeSpeed={70}
          ...
          >
            {/* GitHub */}
            <a
              href="https://github.com/tamjid97"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="GitHub"
              className="p-3 rounded-full bg-slate-100 dark:bg-slate-800/80 border border-slate-200 dark:border-purple-500/20 text-slate-700 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 hover:border-purple-500/50 hover:shadow-lg hover:shadow-purple-500/25 hover:-translate-y-1 transition-all duration-300"
            >
            ...
            <a
              ...
              rel="noopener noreferrer"
              aria-label="LinkedIn"
              className="p-3 rounded-full bg-slate-100 dark:bg-slate-800/80 border border-slate-200 dark:border-purple-500/20 text-slate-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 hover:border-blue-500/50 hover:shadow-lg hover:shadow-blue-500/25 hover:-translate-y-1 transition-all duration-300"
            >
              <svg className="w-5 h-5 sm:w-6 sm:h-6 fill-current" viewBox="0 0 24 24">
            ...
            {/* YouTube */}
            <a
              href="https://www.youtube.com/@TAMJIDHOSSAIN-c1n"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="YouTube"
              className="p-3 rounded-full bg-slate-100 dark:bg-slate-800/80 border border-slate-200 dark:border-purple-500/20 text-slate-700 dark:text-gray-300 hover:text-red-600 dark:hover:text-red-500 hover:border-red-500/50 hover:shadow-lg hover:shadow-red-500/25 hover:-translate-y-1 transition-all duration-300"
            >
              <svg className="w-5 h-5 sm:w-6 sm:h-6 fill-current" viewBox="0 0 24 24">
          ...
          >
            ...
            <a
              href="/S_M_Tamjid_Hossain_Resume.pdf"
            ...
            >
              <svg className="w-5 h-5 fill-current text-purple-500 dark:text-purple-400 transition-transform group-hover:-translate-y-0.5" viewBox="0 0 24 24">
